		...
		<?php if( !$auth_user ) {?>
			<tr>
				<td colspan="2">
					...
					<!--<div class="price_advertising">
						<b><span class="red">Чтобы узнать цену, </span> <noindex><a rel="nofollow" class="login" href="/cart.html">ОТПРАВЬТЕ ВАШУ ЗАЯВКУ</a></noindex></b></br>
						или обратитесь к Независимому партнеру Гербалайф в разделе <noindex><a rel="nofollow" class="contacts" href="contacts">КОНТАКТЫ.</a></noindex>
					</div>-->
				</td>
			</tr>
		<?php } ?>
